...
public class Edge_Test {
    ...
    public void EdgeTest() throws InterruptedException, IOException {
        ...
        //GetOn to Type page
        WebElement element = driver.findElement(By.cssSelector("div.entry-card-pair:nth-child(3) > div:nth-child(1) > div:nth-child(2) > a:nth-child(3)"));
        Thread.sleep(2000);
