...
public class Chrome_Test {
    ...
    public void TestStatisticsDashboard() throws InterruptedException, IOException {
        ...
        //Croatia State Page
        driver.findElement(By.xpath("/html/body/app-root/app-header/header/div[1]/span/span[3]/span/a[8]/span[2]")).click();
        Thread.sleep(2000);
        ...
        Thread.sleep(2000);
        driver.findElement(By.xpath("/html/body/app-root/app-header/header/div/span/span[3]/span/a[8]/span[2]")).click();
        Thread.sleep(2000);
